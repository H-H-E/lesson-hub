...
1. Identify 3 key features of Life Cycles
2. Explain relationship between Life Cycles and everyday life
3. Demonstrate understanding through creative project
4. Connect Life Cycles to another subject
...
**Key Metaphor:** Life Cycles = system
...
### Explore (15 min)
Hands-on with Life Cycles
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Life Cycles
...
function draw() {
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Life Cycles!", 0, 150);
}
```
...
# Explorer's Journal: Life Cycles
...
# Teacher Notes: Life Cycles

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Life Cycles matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
