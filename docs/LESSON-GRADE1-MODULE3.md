...
1. Identify 3 key features of Light and Shadow
2. Explain relationship between Light and Shadow and everyday life
3. Demonstrate understanding through creative project
4. Connect Light and Shadow to another subject
...
**Key Metaphor:** Light and Shadow = system
...
Mystery about Light and Shadow
...
### Explore (15 min)
Hands-on with Light and Shadow
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Light and Shadow
...
function draw() {
  ...
  text("Light and Shadow", width/2, 40);
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Light and Shadow!", 0, 150);
}
```
...
**Output:** Presentation
### Quest
Find Light and Shadow in 3 places
...
# Explorer's Journal: Light and Shadow
...
# Teacher Notes: Light and Shadow

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Light and Shadow matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
