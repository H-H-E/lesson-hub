...
1. Identify 3 key features of Chemical Reactions
2. Explain relationship between Chemical Reactions and everyday life
3. Demonstrate understanding through creative project
4. Connect Chemical Reactions to another subject
...
**Key Metaphor:** Chemical Reactions = system

Chapter 7: You are not an atom - you're a process in processes.

---

## 🎭 The Hook

Mystery about Chemical Reactions
...
### Explore (15 min)
Hands-on with Chemical Reactions
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Chemical Reactions
...
function draw() {
  ...
  text("Chemical Reactions", width/2, 40);
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Chemical Reactions!", 0, 150);
}
```
...
**Output:** Presentation
### Quest
Find Chemical Reactions in 3 places
...
# Explorer's Journal: Chemical Reactions
...
# Family Guide: Chemical Reactions
...
# Teacher Notes: Chemical Reactions

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Chemical Reactions matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
