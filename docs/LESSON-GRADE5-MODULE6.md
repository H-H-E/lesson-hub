...
1. Identify 3 key features of Sustainability
2. Explain relationship between Sustainability and everyday life
3. Demonstrate understanding through creative project
4. Connect Sustainability to another subject
...
**Key Metaphor:** Sustainability = system
...
function draw() {
  ...
  text("Sustainability", width/2, 40);
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Sustainability!", 0, 150);
}
```
...
**Output:** Presentation
### Quest
Find Sustainability in 3 places
...
# Explorer's Journal: Sustainability
