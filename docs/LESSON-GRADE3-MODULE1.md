...
1. Identify 3 key features of Biodiversity
2. Explain relationship between Biodiversity and everyday life
3. Demonstrate understanding through creative project
4. Connect Biodiversity to another subject
...
**Key Metaphor:** Biodiversity = system
...
### Explore (15 min)
Hands-on with Biodiversity
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Biodiversity
...
function draw() {
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Biodiversity!", 0, 150);
}
```
...
# Explorer's Journal: Biodiversity
