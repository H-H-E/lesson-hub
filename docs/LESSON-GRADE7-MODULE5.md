...
1. Identify 3 key features of Interactions
2. Explain relationship between Interactions and everyday life
3. Demonstrate understanding through creative project
4. Connect Interactions to another subject
...
**Key Metaphor:** Interactions = system
...
### Explore (15 min)
Hands-on with Interactions
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Interactions
...
function draw() {
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Interactions!", 0, 150);
}
```
...
# Explorer's Journal: Interactions
...
# Teacher Notes: Interactions

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Interactions matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
