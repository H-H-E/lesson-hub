# Grade 7 Systems Literacy Unit Overview

## The Story So Far...

Welcome to Chapter **The Computational Revelation**!
...
**Key Insight:** Code is not a nerd priesthood - it's a language for describing process

## Your Journey This Unit

| Week | Topic | Systems Connection | Coding Connection |
|------|-------|-------------------|-------------------|
| 1 | [Topic 1] | What is computation | Algorithms |
| 2 | [Topic 2] | From analog to digital | Data |
| 3 | [Topic 3] | Simulation as understanding | Variables |
| 4 | [Topic 4] | Building systems | Loops |
