...
1. Identify 3 key features of Electricity
2. Explain relationship between Electricity and everyday life
3. Demonstrate understanding through creative project
4. Connect Electricity to another subject
...
**Key Metaphor:** Electricity = system
...
### Explore (15 min)
Hands-on with Electricity
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Electricity
...
function draw() {
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Electricity!", 0, 150);
}
```
...
# Explorer's Journal: Electricity
...
# Teacher Notes: Electricity

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Electricity matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
