...
1. Identify 3 key features of Body Systems
2. Explain relationship between Body Systems and everyday life
3. Demonstrate understanding through creative project
4. Connect Body Systems to another subject
...
**Key Metaphor:** Body Systems = system
...
### Explore (15 min)
Hands-on with Body Systems
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Body Systems
...
function draw() {
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Body Systems!", 0, 150);
}
```
...
# Explorer's Journal: Body Systems
...
# Teacher Notes: Body Systems

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Body Systems matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
