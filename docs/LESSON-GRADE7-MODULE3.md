...
1. Identify 3 key features of Earth History
2. Explain relationship between Earth History and everyday life
3. Demonstrate understanding through creative project
4. Connect Earth History to another subject
...
**Key Metaphor:** Earth History = system
...
### Explore (15 min)
Hands-on with Earth History
### Discover (10 min)
Class discussion
### Create (15 min)
Student project on Earth History
...
function draw() {
  ...
  angle += 0.02;
  fill(80); textSize(14);
  text("Explore Earth History!", 0, 150);
}
```
...
**Output:** Presentation
### Quest
Find Earth History in 3 places
...
# Explorer's Journal: Earth History
...
# Teacher Notes: Earth History

## Timing
- Hook: 5 min
- Explore: 15 min
## Common Questions
Q: Why does Earth History matter?
A: [Answer]
## Materials
- Gather day before
- Test technology
